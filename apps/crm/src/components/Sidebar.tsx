...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-sidebar bg-white/40 backdrop-blur-2xl border-r border-white/60 shadow-[4px_0_32px_rgba(0,0,0,0.03)] flex flex-col z-50">
      {/* Logo */}
